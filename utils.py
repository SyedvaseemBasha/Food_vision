...
#     """
#     Returns example images of the given class from a local folder.
#     """
#     example_dir = "P:/ML_PROJECTS/food101/example_images/"  # Path to your example images
#     class_path = os.path.join(example_dir, class_name)
    
#     if os.path.exists(class_path):
#         image_files = glob(os.path.join(class_path, "*.jpg"))
#         return random.sample(image_files, min(3, len(image_files)))  # Return 3 random images
#     else:
#         return []
